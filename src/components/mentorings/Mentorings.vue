    ...
    <div v-if="loaded">
      ...
      <transition name="fadeH" mode="out-in">
        <app-button-card
          ...
          @chatHeaderButtonClicked="openChat(selectedMentoring)"
          @dissolveMentoringFooterButtonClicked="dissolveMentoring(selectedMentoring)"
          @closeMentoringFooterButtonClicked="closeMentoring(selectedMentoring)"
        >
          <app-mentoring :mentoring="selectedMentoring" />
        </app-button-card>
      </transition>
    </div>
...
export default {
  ...
  methods: {
    ...
    /**
     * opens the chat for this mentoring
     * @param mentoring: the chats's mentoring
     */
    openChat(mentoring) {
      console.log("[Mentoring][TODO]: open chat for ", mentoring);
    },
    /**
     * Dissolve the mentoring
     * @param mentoring: the mentoring to dissolve
     */
    dissolveMentoring(mentoring) {
      console.log("[Mentoring][TODO]: dissolve ", mentoring);
    },
    /**
     * Close a mentoring
